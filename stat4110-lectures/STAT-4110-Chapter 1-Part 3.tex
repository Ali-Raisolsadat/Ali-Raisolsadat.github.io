...
\begin{center}
\includegraphics[scale=0.3]{Chapter1-Rejection-Sampling-HistogramU.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.3]{Chapter1-Rejection-Sampling-HistogramX.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.35]{Example-function-plot-Chap1.png}
\end{center}
\end{frame}
