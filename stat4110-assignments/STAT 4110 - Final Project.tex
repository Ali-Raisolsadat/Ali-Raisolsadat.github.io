...
\title{\textbf{Final Project Options \\ STAT 4110 Statistical Simulation \\ Winter 2026 Semester}}
\author{School of Mathematical and Computational Sciences \\ Ali Raisolsadat}
...
This project is designed to introduce you to real-world applications of statistical simulation, stochastic modelling, and analytical reasoning. Each option involves developing a model, justifying assumptions, and using simulation-based or analytical methods to investigate system behaviour. You may use any dataset or programming language of their choice, unless otherwise specified.
...
\begin{enumerate}
    ...
    \item \textbf{Summary Report} (5 pages max, 15/30 points):  
    A detailed report summarizing the approach, implementation, results, and discussion. Include any supporting figures, tables, or appendices as needed.
\end{enumerate}
