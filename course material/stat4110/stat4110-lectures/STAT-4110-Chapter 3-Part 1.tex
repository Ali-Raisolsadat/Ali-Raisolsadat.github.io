...
\end{itemize}
    ...
    \begin{column}{0.30\textwidth}
        \begin{center}
            \includegraphics[width=\textwidth]{ulam_colored.jpg} % Replace with actual file
            \\[0.5em]
            \footnotesize Stanislaw Ulam holding a harmonograph
        \end{center}
\end{column}
\end{columns}
\end{frame}
...
%-------------------
\begin{frame}{Multiple Particles in a Random Medium}
\begin{center}
\includegraphics[width=0.4\textwidth]{meme_16.jpg}
\end{center}
\end{frame}
