...
The explanatory variable was the change in nonexercise activity (NEA) measured in Calories. The response variable was fat gain measured in kilograms.
...
The formula $y \sim  x$ means that the response variable \texttt{y} is modelled as a function of the explanatory variable \texttt{x}.
\end{frame}
