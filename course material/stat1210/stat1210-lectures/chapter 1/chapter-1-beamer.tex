...
\begin{frame}{The Course Roadmap}
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{III: Foundations of Inference}
      \begin{itemize}
      ...
      \end{itemize}
      \vspace{0.1cm}
      \textbf{IV: Specific Inference Procedures}
      \begin{itemize}
...
\begin{frame}{Anatomy of a Histogram}
  \centering
  \lectureimage[0.82\linewidth]{fig_hist_anatomy.png}
\end{frame}
...
\begin{frame}{Break Time}
  \centering
  \lectureimage[0.60\linewidth]{meme_1.jpg}
\end{frame}


% SLIDE 33
\begin{frame}{How to Describe a Quantitative Distribution: SOCS}
  When asked to describe a histogram use \textbf{SOCS}:
  \vspace{0.25cm}
