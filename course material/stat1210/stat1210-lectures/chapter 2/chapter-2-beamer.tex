...
\begin{frame}{The Limits of Human Perception}
  \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{The Solution:} We need to translate our visual descriptions—Shape, Outliers, Center, and Spread (SOCS)—into objective, reproducible mathematical summaries.
  \end{itemize}
\end{frame}

%% SLIDE 3: Chapter Learning Objectives
...
\begin{frame}{The Mean ($\bar{x}$)}
  ...
  In statistics, we use the uppercase Greek letter sigma ($\sum$) to mean "add them all up." Therefore, the compact formula is:
  $$ \bar{x} = \frac{1}{n} \sum x_i $$
\end{frame}

% SLIDE 6: Mean Notation Note
\begin{frame}{Notation Note: Sample vs. Population}
  \begin{itemize}
    ...
    \item $\bar{x}$ is pronounced \textbf{"x-bar."}
  \end{itemize}
  \vspace{0.3cm}
...
% SLIDE 7: Example 2.3 - Mean of Pine Needles (Setup)
\begin{frame}{Example 2.3: Mean of Pine Needle Lengths}
  Let's find the mean needle length for a sample of $n = 15$ Aleppo pine needles. First, we organize our observations ($x_i$):
  \vspace{0.2cm}
  \begin{table}
    \centering
    \scriptsize
...
% SLIDE 8: Example 2.3 - Mean of Pine Needles (Calculation)
\begin{frame}{Example 2.3: Calculating the Mean}
  ...
  \vspace{0.3cm}
  \emph{Takeaway:} In practice, R calculates this instantly. However, the formula reminds us of a critical fact: \textbf{the mean mathematically incorporates the actual numerical value of every single observation.}
\end{frame}

% SLIDE 9: R Code - Mean
\begin{frame}[fragile]{Example 2.3: Calculating the Mean in R}
  Instead of calculating by hand, we can use R to find the mean instantly.
  \vspace{0.3cm}
  \begin{block}{R Code}
  \begin{verbatim}
...
\begin{frame}{The Median ($M$)}
  \begin{itemize}
    ...
    \item It is the 50th percentile—the number such that exactly half (50\%) of the observations are smaller and the other half are larger.
  \end{itemize}
  \vspace{0.3cm}
  \textbf{How to locate the median ($M$) by hand:}
  \begin{enumerate}
    \item \textbf{Sort} all observations in order from smallest to largest.
    \item Use the location rule: the median is always located at position \textbf{$\frac{n+1}{2}$} in the ordered list.
    \item If $n$ is \textbf{odd}, this lands on a single center number. If $n$ is \textbf{even}, this lands between two numbers, and you take their average.
  \end{enumerate}
\end{frame}

% SLIDE 11: Software Note on Median
...
% SLIDE 12: Example 2.1 - Median (Odd n)
...
% SLIDE 14: Example 2.2 - Median (Even n)
...
% SLIDE 17: Resistance Example (Data)
...
% SLIDE 19: Shape Determines the Center
...
% SLIDE 20: Example 2.4 - Flooding
\begin{frame}{Example 2.4: Flooding in Coastal Communities}
  Number of flood events recorded (2009--2013) in 52 Atlantic coastal communities. 
  \vspace{0.2cm}
  \begin{itemize}
    \item \textbf{Shape:} Noticeably skewed to the right (most communities have moderate floods, a few hotspots have massive numbers).
    \item \textbf{Median ($M$):} 37.5 flood events
    \item \textbf{Mean ($\bar{x}$):} 55.3 flood events
  \end{itemize}
  \vspace{0.2cm}
  If the hardest-hit community had a typo, logging \textbf{2,500} floods instead of 250:
  \begin{itemize}
    \item The median would remain exactly \textbf{37.5}.
    \item The mean would skyrocket to \textbf{98.6}.
  \end{itemize}
\end{frame}

% SLIDE 21: Shape Determines the Center (Visual)
\begin{frame}{Visualizing Right-Skewed Data}
  \begin{center}
    \includegraphics[width=0.75\textwidth]{fig_ch2_skewed_mean_median.png}
  \end{center}
  \vspace{0.2cm}
  \begin{alertblock}{First-Year Rule of Thumb}
    The mean is \emph{always} drawn toward the long tail of a skewed distribution!
  \end{alertblock}
\end{frame}

% SLIDE 22: Biological Application: Survival Times
...
% SLIDE 23: Measuring Spread Intro
...
% SLIDE 25: Calculating Quartiles
...
% SLIDE 26: Example 2.5 - Quartiles (Odd n)
...
% SLIDE 27: R Code - Quartiles (Odd n)
...
% SLIDE 28: Example 2.6 - Quartiles (Even n)
...
% SLIDE 29: R Code - Quartiles (Even n)
...
% SLIDE 30: Software Note: Quartile Algorithms
\begin{frame}{Software Note: Quartile Algorithms in R}
  ...
  \begin{itemize}
    ...
    \item Our hand-calculation rule is simply the easiest way to do it manually. 
...
% SLIDE 33: The Five-Number Summary
...
% SLIDE 34: Boxplots: Visualizing the Summary
...
% SLIDE 35: Side-by-Side Comparisons (CRISPR)
...
% SLIDE 36: Identifying Outliers (1.5 x IQR)
...
% SLIDE 38: Measuring Spread: Standard Deviation
...
% SLIDE 39: The Math Behind Standard Deviation
...
% SLIDE 41: Example 2.7 - Metabolic Rates (Setup)
...
% SLIDE 42: Example 2.7 - Deviations Table
...
% SLIDE 43: Example 2.7 - Variance and SD
...
% SLIDE 44: R Code - Variance and SD
...
% SLIDE 45: Properties of the Standard Deviation
...
% SLIDE 46: Choosing the Right Summary
...
% SLIDE 48: Summary of R Commands
...
% SLIDE 49: Chapter 2 Summary Checklist
