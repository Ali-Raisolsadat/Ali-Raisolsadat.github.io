...
\footnotesize
\textbf{Step 1: Calculate the means and Deviations}
There are $n=5$ paired observations.
$$
	\bar{x}=\frac{\sum x_i}{n} =\frac{4+5+6+7+8}{5} =\frac{30}{5} =6.0
$$

$$
	\bar{y}=\frac{\sum y_i}{n} =\frac{32+42+48+55+65}{5}=\frac{242}{5} =48.4
$$
...
\midrule
$4$ & $-2$ & $4$ & $32$ & $-16.4$ & $268.96$ \\
$5$ & $-1$ & $1$ & $42$ & $-6.4$ & $40.96$ \\
$6$ & $0$ & $0$ & $48$ & $-0.4$ & $0.16$ \\
$7$ & $1$ & $1$ & $55$ & $6.6$ & $43.56$ \\
$8$ & $2$ & $4$ & $65$ & $16.6$ & $275.56$ \\
\midrule
\textbf{Sum}& $\mathbf{0}$& $\mathbf{10}$& {}& $\mathbf{0}$& $\mathbf{629.20}$ \\
\bottomrule
\end{tabular}
\end{center}
\end{frame}
...
\begin{frame}{Example 3.11: Calculating Pearson Correlation}
\footnotesize
\textbf{Step 2a: Calculate the sample standard deviation of $x$}
\[
...
Therefore
\[
s_x=\sqrt{\frac{10}{5-1}} =\sqrt{2.5}\approx 1.581
\]

\textbf{Step 2b: Calculate the sample standard deviation of $y$}
\[
s_y=\sqrt{\frac{\sum_{i=1}^{n}(y_i-\bar{y})^2}{n-1}}
\]
From table above we have
\[
\sum (y_i-\bar{y})^2 = 629.20
\]
Therefore
\[
s_y=\sqrt{\frac{629.20}{5-1}} =\sqrt{\frac{629.20}{4}} \approx 12.542
\]
...
\begin{frame}{Example 3.11: Calculating Pearson Correlation}
\footnotesize
\textbf{Step 3a: Standardize the frog-length values}

The standardized value of $x_i$ is
\[
z_{x_{i}}=\frac{x_i-\bar{x}}{s_x}
\]

Using $\bar{x}=6$ and $s_x\approx1.581139$
\[
\begin{aligned}
z_{x_1}
&=\frac{4-6}{1.581139} =\frac{-2}{1.581139} =-1.264911 \approx -1.265 \\[1mm]
z_{x_2}
&=\frac{5-6}{1.581139} =\frac{-1}{1.581139} =-0.632456 \approx -0.632 \\[1mm]
z_{x_3}
&=\frac{6-6}{1.581139} =0\\[1mm] 
z_{x_4}
&=\frac{7-6}{1.581139} =\frac{1}{1.581139} =0.632456 \approx 0.632 \\[1mm]
z_{x_5}
&=\frac{8-6}{1.581139} =\frac{2}{1.581139} =1.264911 \approx 1.265
\end{aligned}
\]
\end{frame}
...
\begin{frame}{Example 3.11: Calculating Pearson Correlation}
\footnotesize
\textbf{Step 3b: Standardize the leap-distance values}

The standardized value of $y_i$ is
\[
	z_{y,i}=\frac{y_i-\bar{y}}{s_y}
\]

Using $\bar{y}=48.4$ and $s_y\approx12.541930$
\[
\begin{aligned}
z_{y_1}
&=\frac{32-48.4}{12.541930} =\frac{-16.4}{12.541930} =-1.307614 \approx -1.308 \\[1mm]
z_{y_2}
&=\frac{42-48.4}{12.541930} =\frac{-6.4}{12.541930} =-0.510288 \approx -0.510\\[1mm]
z_{y_3}
&=\frac{48-48.4}{12.541930} =\frac{-0.4}{12.541930} =-0.031893 \approx -0.032 \\[1mm]
z_{y_4}
&=\frac{55-48.4}{12.541930} =\frac{6.6}{12.541930} =0.526235 \approx 0.526 \\[1mm]
z_{y_5}
&=\frac{65-48.4}{12.541930} =\frac{16.6}{12.541930} =1.323560 \approx 1.324
\end{aligned}
\]
...
\begin{frame}{Example 3.11: Calculating Pearson Correlation}
\small
\textbf{Step 4: Multiply the paired $z$-scores}
\vspace{0.2cm}
The products use the unrounded $z$-scores:
\[
\begin{aligned}
z_{x_1}z_{y_1}
&=(-1.264911)(-1.307614) =1.654015 \approx1.654 \\[1mm] 
z_{x_2}z_{y_2}
&=(-0.632456)(-0.510288) =0.322735 \approx0.323 \\[1mm]
z_{x_3}z_{y_3}
&=(0)(-0.031893) =0 \\[1mm]
z_{x_4}z_{y_4}
&=(0.632456)(0.526235) =0.332820 \approx0.333\\[1mm]
z_{x_5}z_{y_5}
&=(1.264911)(1.323560) =1.674186 \approx1.674
\end{aligned}
\]
\end{frame}
...
\begin{frame}{Example 3.11: Calculating Pearson Correlation}
\scriptsize
\textbf{Step 5: Summarize the calculations}
\begin{center}
\begin{tabular}{ccccc}
\toprule
...
\textbf{Step 6: Substitute into the correlation formula}
\[
...
% SLIDE 26
\begin{frame}[fragile]{Example 3.11: Correlation in R Using Sums (Method 2)}
...
% SLIDE 28
\begin{frame}[fragile]{Example 3.11: Correlation in R (Method 4)}
